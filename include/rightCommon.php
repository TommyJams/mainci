...
<div id="headerBox" class="box">
	...
	<div class="boxBody">
		...
		<div id="loginBox" class="parent">
			...
			<div class='fb-login-button' size='large' onlogin=facebookLoginCallback(); registration-url='<? print(base_url()); ?>fbconnect/registerMethod/noregister' data-auto-logout-link='true'/>
			<?	
			}
			?>
