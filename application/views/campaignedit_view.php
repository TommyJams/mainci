...
<html>
<head>
<title>TommyJams - Start Campaign</title>
        ...
        <div class="row d-tj-tour">
          ...
          <div class="col-sm-12 col-md-5 d-tj-black-box-container" >
            <div class="d-tj-black-box d-tj-tour-right-edit" >
              <input class="form-control input-lg pull-left" type="text" id="target" name="target" placeholder="ENTER TARGET AMOUNT [MIN: &#8377 <? print($min_target); ?>]"></input>
