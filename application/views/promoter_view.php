...
<head>
  ...
  /*  function promoterProfileCallback(a)
    ...
    function editProfile(type,obj)
    {
      ...
      $.post('promoter/editProfile',{'type': type, 'fb': obj.fb, 'twitter': obj.twitter, 'rever': obj.reverbnation, 'youtube': obj.youtube, 'soundcloud': obj.soundcloud, 'otherl': obj.otherl},editProfileCallback,'json');
