              ...
              <div class=" col-md-12" style="padding: 5px;">
                ...
                <div class="d-tj-slide-body " style="">
                  <div class="d-tj-slide-img" onclick="window.open('<?print(base_url().'campaign/'.$campaign_id);?>', '_blank');" style="background-image:url(<? print(base_url().'images/artist/campaign/'.$image); ?>)">  
                    ...
                    <div class="d-tj-slide-hover-img hide"> <img src="/image/radioone/icon/image_overlay_grey.png" alt=""/> </div>
                  </div>
          ...
          <div class="col-md-12 d-tj-col-1-bg" >
            <div class="d-tj-events" >
              ...
              <div class="event-ticker">
                <ul>
                  <li>
                  <a href="http://tommyjams.com/blog/events/event/perfect-strangers-phoenix-martketcity-bangalore/" target="_blank" class="" style="width: 100%">
                  ...
                  <a href="http://tommyjams.com/blog/events/event/dayglocrazie-the-humming-tree/" target="_blank" class="" style="width: 100%">  
                    <div class="col-md-12 col-sm-12 col-xs-12 d-tj-offset-top-10 ">
                      <div class="col-md-2 col-xs-3 col-sm-2 d-tj-p0"> <img src="/image/eventTiles/hummingtree.jpg" alt=""></div>
                      <div class="col-md-10 col-xs-9 col-sm-10 d-tj-p0">
                        <div class="col-md-9 col-sm-9 col-xs-12 d-tj-p0" >
                          <h5>Dayglocrazie @ The Humming Tree</h5>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 event-date" >
                          <h5>6-Nov</h5>
                        </div>
                  ...
                  <a href="http://tommyjams.com/blog/events/event/zarra-phoenix-marketcity/" target="_blank" class="" style="width: 100%">  
                    <div class="col-md-12 col-sm-12 col-xs-12 d-tj-offset-top-10 ">
                      ...
                      <div class="col-md-10 col-xs-9 col-sm-10 d-tj-p0">
                        <div class="col-md-9 col-sm-9 col-xs-12 d-tj-p0" >
                          <h5>Zarra @ Phoenix Marketcity</h5>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 event-date" >
                          <h5>2-Nov</h5>
                        </div>
