      ...
      <div class="d-tj-box d-tj-offset-top-40" >
        <div class="row d-tj-tour">
          <div class="col-sm-12 col-md-5 d-tj-black-box-container" >
            ...
            <div class="who-campaigns">
              ...
              <div class="text-center" >
                <input style="margin-top:10px" class="apply-btn" onclick="window.open('http://tommyjams.com/solstice', '_blank');" type="button" value="ATTEND NOW">
          ...
          <div class="col-sm-12 col-xs-12 col-md-7"> 
            ...
            <a href="http://onesolstice.com/solstice-bangalore" target="_blank"><img align="right" src="/images/solstice/solstice_logo.jpg" style="min-height: 350px;"></a>
          </div>  
        </div>
      </div>
      <!--/About Solstice--> 
