	...
	<div id="loginPopupBox" style="display:none;">
        ...
        <center>
			...
			<div id="loginBoxDetails">
				<div class='fb-login-button'  fb_only='true' fb_register='true' size='xlarge' onlogin=facebookLoginCallback(); registration-url='http://tommyjams.com/fbconnect/registerMethod/noregister'></div>
			</div>
        </center>
    </div>
