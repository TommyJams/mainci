            ...
            <div id="myTabContent" class="tab-content">
              <div class="tab-pane fade active in" id="home">
                <div class="d-tj-pledge">
                  ...
                  <div>  
                    <h5 style="font-size:25px !important;font-family:'Dosis',sans-serif;margin-top:-40px;margin-left:230px">&#8377 </h5>
                    <h5> 
                  ...
                  <div>  
                    <h4 style="font-size:25px !important;font-family:'Dosis',sans-serif;margin-top:-40px;margin-left:230px">&#8377 </h4> 
